...
/*   Updated: 2019/05/27 19:20:48 by sshawnta         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		while (str[k] != '\0')
		{
        	if (str[k] == '%')
        	{
				...
				while (str[k] != '\0')
            	{
                	if (str[k] == '%')
                    	h++;
                	if (str[k] == 'c' || str[k] == 'C' || str[k] == 's' || str[k] == 'p' || str[k] == 'd'
                    	|| str[k] == 'i' || str[k] == 'o' || str[k] == 'O' || str[k] == 'x' || str[k] == 'f'
